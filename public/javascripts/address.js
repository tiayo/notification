$.fn.sjld = function(shenfen,chengshi,quyu){
	...
	var provincecode = $('#sfdq_num').val();
	var citycode = $('#csdq_num').val();
	var sfgsmr = provinceList;
	var csgsmr = provinceList[provincecode].cityList;
	var qygsmr = provinceList[provincecode].cityList[citycode].areaList;
	var kuandu = new Array();

    //默认城市
    $(sfp).text(sfgsmr[provincecode].name);
    $(csp).text(csgsmr[citycode].name);
    $(qyp).text(qygsmr[citycode].name);
