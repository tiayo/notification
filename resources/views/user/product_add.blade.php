...
<!--     <h3 class="item fs-14"><i class="ydh"></i>我的广告</h3>
  ...
  <div class="main-right fr clearfix">
    <div class="content CIndiBg">
   		<div class="CIndi">
            <div class="CIndiInner">
                <div class="CIndiInnerR">
                    ...
                    <form id="product_form" method="post" action="/user/product_add_tijiao">
                    	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    	<input type="hidden" name="dianpu_id" value="{{$dianpu_id}}" />
                    	<div class="rscla">
                        	<dl>
                            	<dt><span>*</span>&nbsp;选择分类：</dt>
                                <dd class="clat1">
                                    <input type="hidden" name="cid" id="cid" value="0" />
                                    <label class="clatxt1" onclick="showProductCate();" id="cate_name"><span style=" color:#f00; ">点击选择</span></label>
                                </dd>
                            ...
                            <dl>
                                ...
                                <dd class="clat1"><input type="text" class="clatxt1" name="title"/></dd>
                            </dl>
                           
                            <dl>
                            	<dt><span>*</span>&nbsp;关键词：</dt>
                                <dd class="clat3"><input type="text" class="clatxt3" name="keywords[]"/></dd>
                                <dd class="clat3"><input type="text" class="clatxt3" name="keywords[]"/></dd>
                                <dd class="clat3"><input type="text" class="clatxt3" name="keywords[]"/></dd>
                                <dd class="clat3"><input type="text" class="clatxt3" name="keywords[]"/></dd>
                        ...
                        <div class="rscla">
                        	<div class="rst"><span>*</span>&nbsp;<strong>运费设定：</strong><input type="text" style="border: 1px solid #DADADA;height: 26px;padding: 0 0 0 7px;line-height: 26px;color: #AAA;" name="yunfei"/></div>
                        </div>
                        <div class="rscla">
                        	<div class="upload_color">
                                <h2>
                                    <font style="color: Red;">*</font><font style="font-weight:700; color:#333;">价格标题：</font><input type="text" style="border: 1px solid #DADADA;height: 26px;padding: 0 0 0 7px;line-height: 26px;color: #AAA;" id="txtys" name="jiage_title">
                                </h2>
                                <div id="price_list">
                                     <dl>
                        ...
                        <div class="rscla clabor">
                            ...
                            <div class="editor">
                                  <script id="editor" type="text/plain" style="width:802px;height:300px; float:left;" name="detail"><p>输入你想展示的信息</p></script>
        ...
        <ul>
    @foreach ($fenlei as $fenlei)
            <li>
                <p>{{$fenlei['dingji']}}</p>
                <dl>
					@if(!empty($fenlei['erji']))
                    @for($i=0;$i<count($fenlei['erji']);$i++)
                    <dd><a href="javascript:void(0)" data="{{$fenlei['erji_id'][$i]}}">{{$fenlei['erji'][$i]}}</a></dd>
                    @endfor
                    @endif
                 </dl>
          </li>
